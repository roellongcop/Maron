...
(5, 10002, '23', '23', '23', 'December 15, 2017', 0),
...
(1, 'Supply And Installation', '23', 23.00, 'Lot', 0.00, 23.00, 23.00),
(2, 'Transportation', '', 0.00, '', 23.00, 23.00, 46.00),
(3, 'Supply And Installation', '23', 23.00, 'Box', 23.00, 23.00, 46.00);
...
--
ALTER TABLE `tbl_preference`
  MODIFY `preference_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
