...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2017 at 03:24 PM
...
INSERT INTO `tbl_request` (`request_id`, `client_id`, `project_name`, `address`, `description`) VALUES
(1, 10028, '34', '43', '43'),
(2, 10028, 'new', 'san jose', 'bungaloo house'),
(3, 10029, 'we', 'we', 'we');
...
--
ALTER TABLE `tbl_client`
  MODIFY `client_no` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10030;
--
...
--
ALTER TABLE `tbl_preference`
  MODIFY `preference_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `tbl_temp_preference`
  MODIFY `preference_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
--
...
--
ALTER TABLE `tbl_work_description`
  MODIFY `work_des_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
