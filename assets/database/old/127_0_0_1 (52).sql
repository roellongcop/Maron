...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2017 at 10:59 AM
...
(10001, 'longcop rivera roel', 'engineer', '09078267471', 'roel@gmail.com', 'san jose gma', 0, 1, 'longcop', 'longcop', 'client');
...
(10001, 10001, 10001, 16277, 13723, 'Pending', 'uploads/projects/project.png', 10001, 0),
(10002, 10002, 10001, 0, 4, 'Pending', 'uploads/templates/project.png', 10001, 0);
...
--
ALTER TABLE `tbl_quotation`
  MODIFY `quotation_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10003;
--
