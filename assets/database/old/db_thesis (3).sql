...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 11, 2018 at 03:46 PM
...
(10001, 'admin', 'Yqlq2o2j2MhAwnrp9u8ip4djxA731b/wiAN7NhPstRkQTlLQSIuqH9qCA8CQDigC7xyVi83DbyhV7O44uHB+Ow==', 'Admin123', 'admin#gmail.com', 'Male', 'Carmona', 'Administrator', 'uploads/accounts/roel.jpg', 'sampleCode', 0),
(10002, 'roel', 'gRSCDmVF/NHFIEH52JCzoPdo+3Rbrxy0/1EVaUKEe/M4nuHlzmO7PRYIrQCD8gRhI5AuALf8xLKPm0qwN8DJIw==', 'roel rivera longcop', 'roellongcop11@gmail.com', 'Male', 'San Jose, GMA, Cavite', 'Engineer', 'uploads/accounts/1.jpg', 'b1cd3802f4', 0);
...
(10001, 'Roel R. Longcop', 'Engineer', '09078267471', 'roel@gmail.com', 'san jose GMA, cavite', 0, 1, 'roel', 'Thznfnq8zMzh1rFNiLH1+yy0dt7R9DXBu1OXskSHrFyconKSZWiQ4DVBTvL6P4KreImr+MzvL0SNcI3cb8UfOQ==', 'client'),
(10003, 'annabelle gernale', 'secretary', '09293747598', 'abelgernale17@gmail.com', 'gma', 0, 1, 'anna', 'C+r1ZovGLz8KMj0OXvQY9DwDywvmuVjiejyyAPJKCdlSV8MIpwOUuYtXKptM8BLskE19FnuPtdVG3brdXDa+3A==', 'a70f9e38ff');
...
--
ALTER TABLE `tbl_account`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10016;
--
...
--
ALTER TABLE `tbl_quotation`
  MODIFY `quotation_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `tbl_request`
--
ALTER TABLE `tbl_request`
  MODIFY `request_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10002;
--
