...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2017 at 06:17 AM
...
(1, 10001, '', '', '', 'December 04, 2017', 1),
(2, 10001, '2 STOREY BLDG.', 'Sta. Rosa Binan Laguna', 'THE CONSTRUCTION OF TWO STOREY COMMERCIAL/RESIDENTIAL BLDG.', 'December 04, 2017', 0),
(3, 10001, 'aasdasdasdasdsdasdasdas', 'asdasdas', 'dasda', 'December 04, 2017', 0);
...
--
ALTER TABLE `tbl_temp_preference`
  MODIFY `preference_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `tbl_work_description`
  MODIFY `work_des_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
